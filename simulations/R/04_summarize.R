...
# Equation 21 -- full data risk diff ratio
full_riskdiff_ratio_p <- dgp_ratio_tbl %>%
  fullRiskDiffRatioPlot
ggsave(
  plot = full_riskdiff_ratio_p,
  filename = "full-risk-diff-ratio.png",
  path = here("graphs", "2021-01-07"),
  device = "png",
  units = "cm",
  width = 15,
...
ggsave(
  plot = op_norm_p,
  filename = "mean-spectral-norm-comparison.png",
  path = here("graphs", "2021-01-07"),
  device = "png",
  units = "cm",
  width = 20,
